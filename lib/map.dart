    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          Positioned(
            left: 90, // Adjust according to your design
            top: 230, // Adjust according to your design
            child: IconButton(
              onPressed: () {
          ...
          Positioned(
            left: 120, // Adjust according to your design
            top: 130, // Adjust according to your design
            child: IconButton(
              onPressed: () {
          ...
          Positioned(
            left: 05, // Adjust according to your design
          ...
          Positioned(
            left: 280, // Adjust according to your design
            top: 230, // Adjust according to your design
            child: IconButton(
              onPressed: () {
          ...
          Positioned(
            left: 180, // Moved more to the right from 180 to 185
            top: 320, // Adjust according to your design (moved lower)
            child: IconButton(
              onPressed: () {
